...
#    $Conf{FullKeepCnt} = [4];
#
#$Conf{FullKeepCnt} = 1; <== valor original, solsament mante backups de 7 dies
# Camviu el valor, aquest es par guardar les copies de tot un any segons 
# http://sourceforge.net/apps/mediawiki/backuppc/index.php?title=Keep_yearly_backups
# $Conf{FullKeepCnt} = [4, 0, 13, 0, 0, 100];

# Las cuatro copias de seguridad semanales mas recientes
# Una copia de seguridad mensual para mantenerse por un any 
# Una copia de seguridad anual conservados "para siempre" 
